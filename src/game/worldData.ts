...
export const BUILDINGS: BuildingData[] = [
  ...
  { id: 'hall-building', name: 'Community Hall', locationId: 'community', x: 410, y: 655, width: 220, height: 150, wall: 0xf2dfb7, roof: 0x8b5b45, sign: 0xffffff },
...
export const INTERACTIONS: InteractionData[] = [
  ...
  { locationId: 'community', point: { x: 520, y: 825 } },
